 ...
 * implementation adapted from this one:
 *
...
vec4 fxaa(sampler2D tex, vec2 frag_coord, vec2 resolution,
...
uniform vec2 u_fb_resolution_fs;

void main() {
	vec2 frag_coord = v_texcoords * u_fb_resolution_fs;
	gl_FragColor = fxaa(u_scene_texture,
	                    frag_coord,
	                    u_fb_resolution_fs,
	                    v_rgbNW,
	                    v_rgbNE,
